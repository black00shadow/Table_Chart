...
const initialDataFirstMid5 = tableData.tableData.map(item => item.data)
...
const FirstTableView: React.FC<ViewProps> = ({
  ...
  return (
    <ContentRable>
      ...
      <MiddleContent>
        <Line color="#ffffff" margin="10px 0" />
        <ReTable rows={3} columns={6} initialData={initialDataFirstMid5} />
